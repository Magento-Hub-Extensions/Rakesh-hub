...
varienGridMassaction.prototype = {
    ...
    onConfirm: function(fieldName, item) {
        ...
        var stockInputCustom = [];
        
        var reorderInputCustom = [];
        
        var qtyOffsetCustom = [];
        
        jQuery('.stockInputCustom').each(function() {
            //console.log(jQuery(this).val());
            if(jQuery(this).val() != "" ){
            //var elementObj = {};
            //var inputId = jQuery(this).data('pid');
            //elementObj[inputId] = jQuery(this).val();
            stockInputCustom.push(jQuery(this).val());
         ...
         jQuery('.reorderInputCustom').each(function() {
            //console.log(jQuery(this).val());
            if(jQuery(this).val() != "" ){
            //var elementObj = {};
            //var inputId = jQuery(this).data('pid');
            //elementObj[inputId] = jQuery(this).val();
            reorderInputCustom.push(jQuery(this).val());
            }
            
        });
         
         jQuery('.qtyOffsetCustom').each(function() {
            //console.log(jQuery(this).val());
            if(jQuery(this).val() != "" ){
            //var elementObj = {};
            //var inputId = jQuery(this).data('pid');
            //elementObj[inputId] = jQuery(this).val();
            qtyOffsetCustom.push(jQuery(this).val());
            }
            
        });
       
         var myJSON1 = JSON.stringify(stockInputCustom);
         
         var myJSON2 = JSON.stringify(reorderInputCustom);
         
         var myJSON3 = JSON.stringify(qtyOffsetCustom);
        
         new Insertion.Bottom(this.formHiddens, this.fieldTemplate({name: 'stockInputCustom', value: myJSON1}));
         
         new Insertion.Bottom(this.formHiddens, this.fieldTemplate({name: 'reorderInputCustom', value: myJSON2}));
         
         new Insertion.Bottom(this.formHiddens, this.fieldTemplate({name: 'qtyOffsetCustom', value: myJSON3}));
