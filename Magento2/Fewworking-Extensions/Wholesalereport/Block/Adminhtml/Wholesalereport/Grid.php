...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
	...
	protected $_template = 'Dapreport_Wholesalereport::widget/grid/extended.phtml';
    ...
    protected function _prepareCollection()
    {
		...
		//$collection->addAttributeToFilter('wholesaler', array('eq' => $value));
		$collection->getSelect()->joinleft('cataloginventory_stock_item','e.entity_id = cataloginventory_stock_item.product_id', [])->columns('cataloginventory_stock_item.*,reorder_quantity');
