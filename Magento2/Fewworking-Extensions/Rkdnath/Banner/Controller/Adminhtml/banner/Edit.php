...
namespace Rkdnath\Banner\Controller\Adminhtml\banner;
...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Rkdnath_Banner::Banner')
            ->addBreadcrumb(__('Rkdnath Banner'), __('Rkdnath Banner'))
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(__('Rkdnath'), __('Rkdnath'));
