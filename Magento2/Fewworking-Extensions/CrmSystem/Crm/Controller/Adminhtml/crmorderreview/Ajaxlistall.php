...
class Ajaxlistall extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $response['list'] = $this->_view->getLayout()->createBlock('Ueg\Crm\Block\Adminhtml\Crmorderreview')
                ->setTemplate('Ueg_Crm::crmorderreview/index/list.phtml')
                ->toHtml();
        $response['pagination'] = $this->_view->getLayout()->createBlock('Ueg\Crm\Block\Adminhtml\Crmorderreview')
                ->setTemplate('Ueg_Crm::crmorderreview/index/pagination.phtml')
                ->toHtml();
