 ...
 * Class MassFraud
 */
class MassFraud extends \Magento\Backend\App\Action
{
    ...
    if(!is_array($saleslogIds['saleslog'])) {
      ...
      try {
        ...
        $this->messageManager->addSuccess(
          __(
            'Total of %1 record(s) were successfully set as fraud', count($saleslogIds['saleslog'])
          )
        );
      } catch (Exception $e) {
