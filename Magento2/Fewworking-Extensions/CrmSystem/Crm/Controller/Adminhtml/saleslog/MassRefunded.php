 ...
 * Class MassDelete
 */
class MassRefunded extends \Magento\Backend\App\Action
{
    ...
    //echo '<pre>';print_r($saleslogIds);exit();
    if(!is_array($saleslogIds['saleslog'])) {
      ...
      try {
        ...
        $this->messageManager->addSuccess(__('Total of %1 record(s) were successfully set as refunded', count($saleslogIds['saleslog'])));
      } catch (Exception $e) {
