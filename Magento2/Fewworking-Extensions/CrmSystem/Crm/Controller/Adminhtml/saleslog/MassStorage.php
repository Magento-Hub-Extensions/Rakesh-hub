 ...
 * Class MassStorage
 */
class MassStorage extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        try {
          ...
          $this->messageManager->addSuccess(
            __(
              'Total of %1 record(s) were successfully set as storage', count($saleslogIds['saleslog'])
            )
          );
        } catch (Exception $e) {
