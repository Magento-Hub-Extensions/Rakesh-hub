 ...
 * Class Masslayaway
 */
class Masslayaway extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $saleslogIds = $this->getRequest()->getParam();
    if(!is_array($saleslogIds['saleslog'])) {
      ...
      try {
        ...
        $this->messageManager->addSuccess(
          __(
            'Total of %1 record(s) were successfully set as lay-a-way', count($saleslogIds['saleslog'])
          )
        );
      } catch (Exception $e) {
