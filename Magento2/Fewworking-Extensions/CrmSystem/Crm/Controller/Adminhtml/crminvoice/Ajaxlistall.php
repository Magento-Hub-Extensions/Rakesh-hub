...
class Ajaxlistall extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $response['list'] = $this->_view->getLayout()->createBlock('Ueg\Crm\Block\Adminhtml\Crminvoice')
                ->setTemplate('Ueg_Crm::crminvoice/index/list.phtml')
                ->toHtml();
        $response['pagination'] = $this->_view->getLayout()->createBlock('Ueg\Crm\Block\Adminhtml\Crminvoice')
                ->setTemplate('Ueg_Crm::crminvoice/index/pagination.phtml')
                ->toHtml();
