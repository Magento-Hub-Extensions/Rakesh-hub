...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     */
    protected $_template = 'series/grid/extended.phtml';
    ...
    protected function _construct()
    {
        ...
        $this->setVarNameFilter('seriespost_filter');
    }
    ...
    protected function _customHotClientFilterCallBack($collection, $column)
    {
            ...
            $this->getCollection()->getSelect()->where("cei_hc.value like ?", "%$value%");
    ...
    {
        return $this->getUrl('crm/series/grid', array('_current'=> true));
    }
