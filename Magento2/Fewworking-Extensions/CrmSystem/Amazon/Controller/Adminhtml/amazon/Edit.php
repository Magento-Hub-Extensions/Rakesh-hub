...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Ueg_Amazon::Dialer')
            ->addBreadcrumb(__('Ueg Amazon'), __('Ueg Amazon'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Ueg\Amazon\Model\Dialer');
        ...
        $this->_coreRegistry->register('dialer', $model);
