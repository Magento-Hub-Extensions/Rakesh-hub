...
class OrderGenerator
{
    ...
    protected $_shippingMethodCode = 'freeshipping';
    protected $_shippingDescription = 'Free Shipping - Free';
    ...
    public function createOrder($products)
    {
        ...
        if ($shippingInformation = $this->getShippingInformationByCode($this->_shippingMethodCode)) {
            $shippingInformation['method'] = $this->_shippingMethod;
            $this->setShippingInformation($shippingInformation);
        }
    ...
    protected function setShippingInformation($shippingInformation)
    {
        $this->_order
    ...
    protected function getShippingInformationByCode($shippingCode)
    {
        $shippingInformation = [];
